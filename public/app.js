...
var polygon = L.polygon(latlngs, {color: 'blue', fill:""}).addTo(myMap);
...
L.marker([48.866200610611926, 2.352236247419453], {icon: myIcon}).addTo(myMap);
...
const stations = L.layerGroup([sSD, sentier, bourse, qS, gB]).addTo(myMap)
